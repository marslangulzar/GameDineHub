...
;(function ($, window, document, undefined) {
  ...
  function filter(dualListbox, selectIndex) {
    ...
    options.each(function(index, item) {
      var $item = $(item),
        isFiltered = true;
        if (item.text.match(regex) || (dualListbox.settings.filterOnValues && $item.attr('value').match(regex)) || $item.data('description').match(regex)) {
        isFiltered = false;
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.clear1, .clear2').removeClass('btn-default btn-xs').addClass('btn-mini');
          this.container.find('input, select').removeClass('form-control duallistbox');
        this.container.find('.btn').removeClass('btn-default btn-sm');
          this.container.find('.moveall > i, .move > i').removeClass('fal fa-arrow-right fw-700').addClass('icon-arrow-right');
          this.container.find('.removeall > i, .remove > i').removeClass('fal fa-arrow-left fw-700').addClass('icon-arrow-left');
      } else {
        this.container.removeClass('row-fluid bs2compatible').addClass('row');
        this.container.find('.box1, .box2').removeClass('span6').addClass('col-md-6');
        this.container.find('.clear1, .clear2').removeClass('btn-mini').addClass('btn-default btn-xs');
          this.container.find('input, select').addClass('form-control duallistbox');
        this.container.find('.btn').addClass('btn-default btn-sm');
          this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('fal fa-arrow-right fw-700');
        this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('fal fa-arrow-left fw-700');
      }
      if (refresh) {
        refreshSelects(this);
      }
